	...
	<div class="container different-login-container">
            <div class="row">
                    ...
                    %>
	                       ...
	                       <% }else if(localAuthenticatorNames.size()>0 && localAuthenticatorNames.contains("DuoAuthenticator")) {
	                        %>
                                <div class="span3">
                                   <a onclick="javascript: handleNoDomain('<%=idpEntry.getKey()%>','DuoAuthenticator')"  class="main-link" style="cursor:pointer">DUO</a>
                                </div>
                           <%
                            }
